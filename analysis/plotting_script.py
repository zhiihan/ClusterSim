...
from cluster_sim.app import rx_graph_to_plot, grid_graph_3d, Grid3D, BrowserState, update_plot_plotly
...
connected_cubes = max([C.subgraph(list(c)) for c in rx.connected_components(C)], key=len)
